  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const totalStore = response.data;
        ...
        <div className="w-full md:w-1/3  flex flex-col gap-2">
          <div className="bg-white rounded-lg shadow p-4 md:p-6 ">
            ...
            <div className="mt-6 flex flex-col gap-4 ">
              ...
              <StatCard
                label="Total Search For Category"
                value={totalMale}
                color="#f4eeee"
              />
