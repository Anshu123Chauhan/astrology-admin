...
const decodedToken = useMemo(() => {
  ...
  useEffect(() => {
    ...
    superadmin: [
      ...
      { title: "Services", icon: <RiServiceLine />, location: "/product" },
      ...
      // { title: "Filter", icon: <CiFilter />, location: "/filter", permission: "filter" },
      {
        ...
        { title: "Astrologer", icon: <BiSolidDashboard />, location: "/sellerList", permission: "sellerList" },
    ...
    if (decodedToken?.userType === "Seller") {
      const exclude = ["Astrologer", "Category", "Sub Category", "Brand", "Filter","Banner", "settings"];
